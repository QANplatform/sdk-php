...
/**
 * OutputNewPendingTransactionFilter Class Doc Comment
 *
 * @category Class
 * @package  qan
 * @author   OpenAPI Generator team
 ...
 */
class OutputNewPendingTransactionFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Output_newPendingTransactionFilter';
    ...
    */
     ...
     * Sets filter_id
     *
     * @param string $filter_id A filter id to be used when calling getFilterChanges
     *
     * @return self
     */
