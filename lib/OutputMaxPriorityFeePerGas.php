...
/**
 * OutputMaxPriorityFeePerGas Class Doc Comment
 *
 * @category Class
 * @package  qan
 * @author   OpenAPI Generator team
 ...
 */
class OutputMaxPriorityFeePerGas implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Output_maxPriorityFeePerGas';
    ...
    */
     ...
     *
     * @param string $max_priority_fee_per_gas The hex value of the priority fee needed to be included in a block
     *
     * @return self
     */
