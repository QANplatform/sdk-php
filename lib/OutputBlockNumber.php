...
/**
 * OutputBlockNumber Class Doc Comment
 *
 * @category Class
 * @package  qan
 * @author   OpenAPI Generator team
 ...
 */
class OutputBlockNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Output_blockNumber';
    ...
    */
     ...
     * Sets block_number
     *
     * @param string $block_number An integer value of the latest block number encoded as decimal
     *
     * @return self
     */
