...
/**
 * OutputGetTransactionByBlockNumberAndIndex Class Doc Comment
 *
 * @category Class
 * @package  qan
 * @author   OpenAPI Generator team
 ...
 */
class OutputGetTransactionByBlockNumberAndIndex implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Output_getTransactionByBlockNumberAndIndex';
    ...
    protected static $openAPITypes = [
        'schema' => 'string',
        'transaction' => '\qan\qan\ResponseTransaction'
    ];
    ...
    */
     ...
     * Sets transaction
     *
     * @param \qan\qan\ResponseTransaction $transaction The transaction response object, or null if no transaction is found
     *
     * @return self
     */
