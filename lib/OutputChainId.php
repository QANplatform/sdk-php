...
/**
 * OutputChainId Class Doc Comment
 *
 * @category Class
 * @package  qan
 * @author   OpenAPI Generator team
 ...
 */
class OutputChainId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Output_chainId';
    ...
    */
     ...
     * Sets chain_id
     *
     * @param string $chain_id A decimal value in string format which represents an integer of the chain ID
     *
     * @return self
     */
