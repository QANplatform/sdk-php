...
/**
 * OutputGetBlockTransactionCountByNumber Class Doc Comment
 *
 * @category Class
 * @package  qan
 * @author   OpenAPI Generator team
 ...
 */
class OutputGetBlockTransactionCountByNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Output_getBlockTransactionCountByNumber';
    ...
    */
     ...
     *
     * @param string $transaction_count The number of transactions associated with a specific block, in decimal value
     *
     * @return self
     */
