...
/**
 * OutputGetTransactionCount Class Doc Comment
 *
 * @category Class
 * @package  qan
 * @author   OpenAPI Generator team
 ...
 */
class OutputGetTransactionCount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Output_getTransactionCount';
    ...
    */
     ...
     *
     * @param string $transaction_count The integer of the number of transactions sent from an address encoded as decimal
     *
     * @return self
     */
