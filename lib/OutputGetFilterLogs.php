...
/**
 * OutputGetFilterLogs Class Doc Comment
 *
 * @category Class
 * @package  qan
 * @author   OpenAPI Generator team
 ...
 */
class OutputGetFilterLogs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Output_getFilterLogs';
    ...
    */
     ...
     * Sets logs
     *
     * @param \qan\qan\ResponseLog[] $logs An array of log objects, or an empty array if nothing has changed since last poll
     *
     * @return self
     */
