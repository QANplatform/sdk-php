...
/**
 * OutputGasPrice Class Doc Comment
 *
 * @category Class
 * @package  qan
 * @author   OpenAPI Generator team
 ...
 */
class OutputGasPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Output_gasPrice';
    ...
    */
     ...
     * Sets gas_price
     *
     * @param string $gas_price The decimal value of the current gas price in wei
     *
     * @return self
     */
