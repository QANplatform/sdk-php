...
/**
 * OutputSendRawTransaction Class Doc Comment
 *
 * @category Class
 * @package  qan
 * @author   OpenAPI Generator team
 ...
 */
class OutputSendRawTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Output_sendRawTransaction';
    ...
    */
     ...
     *
     * @param string $transaction_hash The transaction hash, or the zero hash if the transaction is not yet available
     *
     * @return self
     */
