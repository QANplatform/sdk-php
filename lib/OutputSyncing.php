...
/**
 * OutputSyncing Class Doc Comment
 *
 * @category Class
 * @package  qan
 * @author   OpenAPI Generator team
 ...
 */
class OutputSyncing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Output_syncing';
    ...
    protected static $openAPITypes = [
        'schema' => 'string',
        'sync_status' => '\qan\qan\SyncStatus'
    ];
    ...
    */
     ...
     * Sets sync_status
     *
     * @param \qan\qan\SyncStatus $sync_status Returns null when the node is fully synchronized, otherwise returns the sync status
     *
     * @return self
     */
